          ...
          {({ errors, touched }) => (
            <Form>
                ...
                <div className="columns">
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="page.contact-us.form.first-name"
                        defaultMessage="First Name"
                      />
                      &nbsp;*
                    </label>
                  ...
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="page.contact-us.form.last-name"
                        defaultMessage="Last Name"
                      />
                      &nbsp;*
                    </label>
              ...
              <div className="field">
                <label className="label">
                  <FormattedMessage
                    id="page.contact-us.form.address"
              ...
              <div className="field">
                <div className="columns">
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="page.contact-us.form.country"
                  ...
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="page.contact-us.form.postal-code"
              ...
              <div className="field">
                <label className="label">
                  <FormattedMessage
                    id="page.contact-us.form.message"
...
export default withIntl(ContactFormForm);
