...
const messages = defineMessages({
  namePlaceholder: {
    id: "commercial-enquiries.store.form.name.placeHolder",
    defaultMessage: "Name of your organization"
  },
  nameMinValidation: {
    id: "commercial-enquiries.store.form.name.min",
    defaultMessage: "Organization Name is too short."
  },
  nameMaxValidation: {
    id: "commercial-enquiries.store.form.name.max",
    defaultMessage: "Organization Name is too large."
  },
  nameRequiredValidation: {
    id: "commercial-enquiries.store.form.name.required",
    defaultMessage: "Organization Name is required."
  },

  addressPlaceholder: {
    id: "commercial-enquiries.store.form.address.placeHolder",
    defaultMessage: "Your organization address"
  },
  addressMinValidation: {
    id: "commercial-enquiries.store.form.address.min",
    defaultMessage: "Address is too short."
  },
  addressMaxValidation: {
    id: "commercial-enquiries.store.form.address.max",
    defaultMessage: "Address is too large."
  },
  addressRequiredValidation: {
    id: "commercial-enquiries.store.form.address.required",
    defaultMessage: "Address is required."
  },

  cityPlaceholder: {
    id: "commercial-enquiries.store.form.city.placeHolder",
    defaultMessage: "City where your organization located on"
  },
  cityMinValidation: {
    id: "commercial-enquiries.store.form.city.min",
    defaultMessage: "City is too short."
  },
  cityMaxValidation: {
    id: "commercial-enquiries.store.form.city.max",
    defaultMessage: "City is too large."
  },
  cityRequiredValidation: {
    id: "commercial-enquiries.store.form.city.required",
    defaultMessage: "City is required."
  },

  statePlaceholder: {
    id: "commercial-enquiries.store.form.state.placeHolder",
    defaultMessage: "Your organization State/Province"
  },
  stateMaxValidation: {
    id: "commercial-enquiries.store.form.state.max",
    defaultMessage: "State is too large."
  },
  stateRequiredValidation: {
    id: "commercial-enquiries.store.form.state.required",
    defaultMessage: "State is required."
  },

  countryPlaceholder: {
    id: "commercial-enquiries.store.form.country.placeHolder",
    defaultMessage: "Country where your organization located on"
  },
  countryMinValidation: {
    id: "commercial-enquiries.store.form.country.min",
    defaultMessage: "Country is too short."
  },
  countryMaxValidation: {
    id: "commercial-enquiries.store.form.country.max",
    defaultMessage: "Country is too large."
  },
  countryRequiredValidation: {
    id: "commercial-enquiries.store.form.country.required",
    defaultMessage: "Country is required."
  },

  postalCodePlaceholder: {
    id: "commercial-enquiries.store.form.postal-code.placeHolder",
    defaultMessage: "Your organization Postal Code"
  },
  postalCodeMinValidation: {
    id: "commercial-enquiries.store.form.postal-code.min",
    defaultMessage: "Postal Code is too short."
  },
  postalCodeMaxValidation: {
    id: "commercial-enquiries.store.form.postal-code.max",
    defaultMessage: "Postal Code is too large."
  },
  postalCodeRequiredValidation: {
    id: "commercial-enquiries.store.form.postal-code.required",
    defaultMessage: "Postal Code is required."
  },

  firstNamePlaceholder: {
    id: "commercial-enquiries.store.form.first-name.placeHolder",
    defaultMessage: "First Name"
  },
  firstNameMinValidation: {
    id: "commercial-enquiries.store.form.first-name.min",
    defaultMessage: "First Name is too short."
  },
  firstNameMaxValidation: {
    id: "commercial-enquiries.store.form.first-name.max",
    defaultMessage: "First Name is too large."
  },
  firstNameRequiredValidation: {
    id: "commercial-enquiries.store.form.first-name.required",
    defaultMessage: "First Name is required."
  },

  lastNamePlaceholder: {
    id: "commercial-enquiries.store.form.last-name.placeHolder",
    defaultMessage: "Last Name"
  },
  lastNameMinValidation: {
    id: "commercial-enquiries.store.form.last-name.min",
    defaultMessage: "Last Name is too short."
  },
  lastNameMaxValidation: {
    id: "commercial-enquiries.store.form.last-name.max",
    defaultMessage: "Last Name is too large."
  },
  lastNameRequiredValidation: {
    id: "commercial-enquiries.store.form.last-name.required",
    defaultMessage: "Last Name is required."
  },

  phonePlaceholder: {
    id: "commercial-enquiries.store.form.phone.placeHolder",
    defaultMessage: "Phone Number"
  },
  phoneMinValidation: {
    id: "commercial-enquiries.store.form.phone.min",
    defaultMessage: "Phone Number is too short."
  },
  phoneMaxValidation: {
    id: "commercial-enquiries.store.form.phone.max",
    defaultMessage: "Phone Number is too large."
  },
  phoneRequiredValidation: {
    id: "commercial-enquiries.store.form.phone.required",
    defaultMessage: "Phone Number is required."
  },

  emailPlaceholder: {
    id: "commercial-enquiries.store.form.email.placeHolder",
    defaultMessage: "Email"
  },
  emailValidation: {
    id: "commercial-enquiries.store.form.email.validation",
    defaultMessage: "Email is invalid."
  },
  emailRequiredValidation: {
    id: "commercial-enquiries.store.form.email.required",
    defaultMessage: "Email is required."
  },

  enquiryPlaceholder: {
    id: "commercial-enquiries.store.form.enquiry.placeHolder",
            ...
            <Form>
              <div className="field">
                <label className="label">
                  <FormattedMessage
                    id="commercial-enquiries.store.form.name"
              ...
              <div className="field">
                <label className="label">
                  <FormattedMessage
                    id="commercial-enquiries.store.form.address"
              ...
              <div className="field">
                <div className="columns">
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="commercial-enquiries.store.form.city"
                        defaultMessage="City"
                      />
                      &nbsp; *
                    </label>
                  ...
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="commercial-enquiries.store.form.state"
              ...
              <div className="field">
                <div className="columns">
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="commercial-enquiries.store.form.country"
                  ...
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="commercial-enquiries.store.form.postal-code"
              ...
              <strong>
                <FormattedMessage
                  id="commercial-enquiries.store.form.contact-title"
              ...
              <div className="field">
                <div className="columns">
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="commercial-enquiries.store.form.first-name"
                        defaultMessage="First Name"
                      />
                      &nbsp;*
                    </label>
                  ...
                  <div className="column">
                    <label className="label">
                      <FormattedMessage
                        id="commercial-enquiries.store.form.last-name"
                        defaultMessage="Last Name"
                      />
                      &nbsp;*
                    </label>
                ...
                <div className="columns">
                  <div className="column">
                    <div className="field">
                      <label className="label">
                        <FormattedMessage
                          id="commercial-enquiries.store.form.phone"
                          defaultMessage="Phone Number"
                        />
                        &nbsp;*
                      </label>
                  ...
                  <div className="column">
                    <div className="field">
                      <label className="label">
                        <FormattedMessage
                          id="commercial-enquiries.store.form.email"
                          defaultMessage="Email"
                        />
                        &nbsp;*
                      </label>
              ...
              <div className="field">
                <label className="label">
                  <FormattedMessage
                    id="commercial-enquiries.store.form.enquiry"
                    defaultMessage="Enquiry"
                  />
                </label>
                <div className="control">
...
export default withIntl(CreateStoreForm);
